...
# For DistilBERT, use raw comment_text if available, else preprocessed
# DistilBERT works better on minimally preprocessed text
...
plt.tight_layout()
plt.savefig(f"{RESULTS_DIR}/cm_distilbert.png", dpi=150)
plt.close()
